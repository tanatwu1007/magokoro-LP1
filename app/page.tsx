          ...
          <div className="flex flex-col sm:flex-row gap-2.5 md:gap-4 mt-1">
            ...
            <a href="tel:0120437599" className="flex-1 bg-gradient-to-b from-[#FF6A00] to-[#e05d00] text-white rounded-xl py-3 md:py-4 px-3 shadow-lg flex items-center justify-center gap-2 border border-[#e65f00] touch-manipulation">
              ...
              <span className="text-left leading-tight">
                ...
                <span className="block text-[16px] md:text-2xl font-extrabold tracking-tight drop-shadow-sm">0120-437-599</span>
              </span>
            </a>
          </div>
          ...
          <div className="text-center md:text-left flex-grow">
            ...
            <div className="mt-6 md:mt-8 flex flex-col items-center md:items-start">
              ...
              <a href="tel:0120437599" className="bg-gradient-to-b from-[#FF6A00] to-[#e05d00] text-white rounded-xl py-3 px-6 shadow-lg flex items-center justify-center gap-3 border border-[#e65f00] w-full sm:w-auto touch-manipulation">
                ...
                <span className="text-left leading-tight">
                  <span className="block text-[10px] md:text-xs font-bold opacity-90 mb-0.5">どんな小さな事でもご相談ください</span>
                  <span className="block text-lg md:text-2xl font-black tracking-tight drop-shadow-sm">代表直通: 0120-437-599</span>
                </span>
              </a>
            </div>
          </div>

...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pb-[100px] md:pb-24 text-gray-800">
      ...
      {/* 🟢 1. ファーストビュー（スマホで綺麗に収まるように文字サイズ・余白を調整） */}
      ...
      <section className="bg-gradient-to-b from-green-50 to-white py-5 md:py-8 px-3 md:px-4 border-b border-gray-200">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 md:gap-4 mt-1">
            ...
            <a href="tel:0120000000" className="flex-1 bg-gradient-to-b from-[#FF6A00] to-[#e05d00] text-white rounded-xl py-3 md:py-4 px-3 shadow-lg flex items-center justify-center gap-2 transition-transform active:scale-95 border border-[#e65f00]">
              ...
              <div className="text-left leading-tight">
                ...
                <div className="text-[15px] md:text-xl font-extrabold tracking-tight drop-shadow-sm">0120-XXX-XXX</div>
              </div>
            </a>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-14">
            ...
            <p className="text-red-600 font-extrabold text-[12px] md:text-lg bg-white py-2.5 px-4 rounded-xl shadow-sm border border-red-200 inline-block w-[98%] md:w-auto leading-relaxed text-balance">
              ★相見積もり大歓迎！<br className="md:hidden"/>以下の料金から、さらに<span className="text-red-600 text-base md:text-2xl mx-1 bg-yellow-100 px-1 rounded">【買取金額】</span>を差し引きます！
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-[3px] border-green-500 relative flex flex-col z-10 transform md:scale-110">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 bg-red-600 text-white text-[10px] md:text-sm font-extrabold px-4 py-1 rounded-b-md shadow-sm z-20 whitespace-nowrap">1番人気！おすすめ</div>
          ...
          <div className="mt-10 bg-white border-2 border-green-200 rounded-xl p-4 md:p-8 text-center shadow-md relative">
            ...
            <div className="flex flex-wrap justify-center gap-1.5 md:gap-4 text-[10px] md:text-sm text-green-800 font-bold">
              ...
              <span className="bg-green-50 px-2 py-1 md:py-1.5 rounded border border-green-100">出張費</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl border border-gray-200 shadow-lg relative overflow-hidden flex flex-col">
              ...
              <div className="p-4 md:p-8 flex-grow flex flex-col justify-between bg-slate-50">
                <div>
                  <div className="bg-green-700 text-white text-[10px] md:text-sm font-bold inline-block px-2.5 py-1 rounded-full mb-2.5 shadow-sm">大和市 A様邸（2LDK 実家の遺品整理）</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="bg-white p-5 md:p-6 rounded-xl md:rounded-2xl shadow-sm border border-gray-200">
              ...
              <p className="text-[12px] md:text-sm text-gray-600 leading-relaxed mb-3">
                一人暮らしなので不安でしたが、女性スタッフ同行をお願いできたので安心して任せられました。気配りしていただき助かりました。
              </p>
      ...
      <section className="py-12 md:py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-8 relative">
            ...
            <div className="text-center relative z-10 bg-slate-50 md:bg-transparent p-3 md:p-0 rounded-xl shadow-sm md:shadow-none border border-slate-200 md:border-none">
              <div className="w-14 h-14 md:w-40 md:h-40 mx-auto rounded-full border-2 md:border-8 border-white shadow-md md:shadow-xl overflow-hidden mb-2 md:mb-5 relative">
                ...
                <div className="absolute top-0 left-0 w-4 h-4 md:w-10 md:h-10 bg-green-600 text-white font-black flex items-center justify-center rounded-br-lg md:rounded-br-xl text-[10px] md:text-xl shadow-sm">1</div>
              </div>
              <h3 className="font-extrabold text-[12px] md:text-xl mb-1 md:mb-3 text-gray-900">無料相談・見積り</h3>
              <p className="text-[9px] md:text-sm text-gray-600 font-medium">LINEで部屋の写真をお送りいただくとスムーズです。</p>
            </div>
            ...
            <div className="text-center relative z-10 bg-slate-50 md:bg-transparent p-3 md:p-0 rounded-xl shadow-sm md:shadow-none border border-slate-200 md:border-none">
              <div className="w-14 h-14 md:w-40 md:h-40 mx-auto rounded-full border-2 md:border-8 border-white shadow-md md:shadow-xl overflow-hidden mb-2 md:mb-5 relative">
                ...
                <div className="absolute top-0 left-0 w-4 h-4 md:w-10 md:h-10 bg-green-600 text-white font-black flex items-center justify-center rounded-br-lg md:rounded-br-xl text-[10px] md:text-xl shadow-sm">2</div>
              </div>
              <h3 className="font-extrabold text-[12px] md:text-xl mb-1 md:mb-3 text-gray-900">現地調査・確定</h3>
              <p className="text-[9px] md:text-sm text-gray-600 font-medium">正確な金額を算出。<span className="text-red-500 font-bold block md:inline mt-0.5">キャンセル無料！</span></p>
            </div>
            ...
            <div className="text-center relative z-10 bg-slate-50 md:bg-transparent p-3 md:p-0 rounded-xl shadow-sm md:shadow-none border border-slate-200 md:border-none">
              <div className="w-14 h-14 md:w-40 md:h-40 mx-auto rounded-full border-2 md:border-8 border-white shadow-md md:shadow-xl overflow-hidden mb-2 md:mb-5 relative">
                ...
                <div className="absolute top-0 left-0 w-4 h-4 md:w-10 md:h-10 bg-green-600 text-white font-black flex items-center justify-center rounded-br-lg md:rounded-br-xl text-[10px] md:text-xl shadow-sm">3</div>
              </div>
              <h3 className="font-extrabold text-[12px] md:text-xl mb-1 md:mb-3 text-gray-900">スピーディな作業</h3>
              <p className="text-[9px] md:text-sm text-gray-600 font-medium">プロが迅速に運び出します。全て丸投げでOK！</p>
            </div>
            ...
            <div className="text-center relative z-10 bg-slate-50 md:bg-transparent p-3 md:p-0 rounded-xl shadow-sm md:shadow-none border border-slate-200 md:border-none">
              <div className="w-14 h-14 md:w-40 md:h-40 mx-auto rounded-full border-2 md:border-8 border-white shadow-md md:shadow-xl overflow-hidden mb-2 md:mb-5 relative">
                ...
                <div className="absolute top-0 left-0 w-4 h-4 md:w-10 md:h-10 bg-green-600 text-white font-black flex items-center justify-center rounded-br-lg md:rounded-br-xl text-[10px] md:text-xl shadow-sm">4</div>
              </div>
              <h3 className="font-extrabold text-[12px] md:text-xl mb-1 md:mb-3 text-gray-900">ご精算（買取相殺）</h3>
              <p className="text-[9px] md:text-sm text-gray-600 font-medium">作業後にお支払い。買取でお得に。</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-20 px-3 md:px-4 bg-slate-100">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl md:rounded-[32px] p-6 md:p-14 shadow-lg flex flex-col md:flex-row items-center gap-6 md:gap-12 border border-slate-200 relative overflow-hidden">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg md:text-3xl font-extrabold text-gray-900 mb-3 md:mb-6 leading-tight tracking-tight">
              大和市を中心に、地元神奈川に<br className="hidden md:block"/>「頼んでよかった」を届けたい。
            </h3>
            <p className="text-gray-700 text-[12px] md:text-lg leading-relaxed md:leading-loose mb-4 md:mb-8 text-left font-medium">
              はじめまして。不用品回収業界では残念ながら「無料と言っていたのに、後から数万円を請求された」といったトラブルが後を絶ちません。<br/><br/>
              だからこそ、私たちは地元密着の企業として<strong className="text-red-600 border-b border-red-200">「お見積り後の追加料金一切なし」「万が一の損害保険加入」「買取による費用削減の徹底」</strong>をお約束します。ご自宅にお伺いする以上、清潔感と礼儀作法を徹底したスタッフのみがお伺いいたします。まずは地元の当店へ安心してご相談ください。
            </p>
            <p className="font-black text-gray-900 text-right text-sm md:text-xl">神奈川 まごころ整理センター 代表</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 px-4 bg-slate-100">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-2 md:gap-3 mb-8 md:mb-14">
            <HelpCircle className="w-6 h-6 md:w-10 md:h-10 text-green-600" />
            <h2 className="text-[22px] md:text-4xl font-extrabold text-gray-900">よくあるご質問</h2>
          </div>
      ...
      <section className="py-12 md:py-20 px-3 md:px-4 bg-gradient-to-b from-white to-green-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-2.5 md:gap-5 justify-center">
            ...
            <a href="tel:0120000000" className="w-full md:w-auto md:px-12 bg-gradient-to-b from-[#FF6A00] to-[#e05d00] text-white rounded-xl md:rounded-2xl py-3.5 md:py-5 shadow-lg flex items-center justify-center gap-2 md:gap-3 transition-transform active:scale-95 border border-[#e65f00]">
              <Phone className="w-6 h-6 md:w-10 md:h-10" />
              <div className="text-left leading-tight">
                <div className="text-[9px] md:text-sm font-bold opacity-90 mb-0.5">最短30分で急行！相談だけでもOK</div>
                <div className="text-lg md:text-2xl font-extrabold tracking-tight drop-shadow-md">0120-XXX-XXX</div>
              </div>
            </a>
          </div>
        </div>
          ...
          <div className="flex gap-1.5 md:gap-2 mt-0.5">
            ...
            >
              <div className="flex items-center gap-1 md:gap-3">
                ...
                <div className="text-left">
                  <div className="text-[8px] md:text-xs font-bold leading-tight opacity-95 mb-0.5">最短30分急行</div>
